            ...
            <tr>
                <td>
                    <table align="center" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                <td><img src="assets/images/email-template/delivery.png" alt=""
                            ...
                            <tr>
                                <td><img src="assets/images/email-template/order-success.png" alt=""
                    ...
                    <table class="order-detail" border="0" cellpadding="0" cellspacing="0" align="left">
                        <tbody>
                            ...
                            <tr>
                                <td><img src="assets/images/email-template/1.png" alt="" width="130"></td>
                                <td valign="top" style="padding-left: 15px;">
                                    <h5 style="margin-top: 15px;">Three seater Wood Style sofa for Leavingroom </h5>
                                </td>
                                <td valign="top" style="padding-left: 15px;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="user-info" width="57" height="25"><img
                                        src="assets/images/email-template/space.jpg" alt=" " height="25" width="57">
                                </td>
                                <td class="user-info"
                                    style="font-size: 13px; font-weight: 400; color: #444444; letter-spacing: 0.2px;width: 50%;">
                                    <h5
