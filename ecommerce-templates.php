                ...
                <td>
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center;"><img
                                        src="assets/images/email-template/delivery-2.png" alt=""
                                        style=";margin-bottom: 30px;"></td>
                            </tr>
                            <tr>
                                <td>
                                    <p style="font-size: 14px;"><b>Hi John Doe,</b></p>
                                    <p style="font-size: 14px;">Order Is Successfully Processsed And Your Order Is On
                                        The Way,</p>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" align="left"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><img src="assets/images/email-template/space.jpg" alt=" " height="25" width="30">
                                </td>
                                <td
                                    style="background-color: #fafafa;border: 1px solid #ddd;padding: 15px;letter-spacing: 0.3px;width: 50%;">
                                    <h5
                    ...
                    <table class="order-detail" border="0" cellpadding="0" cellspacing="0" align="left"
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><img src="assets/images/email-template/4.png" alt="" width="80"></td>
                            ...
                            <tr>
                                <td><img src="assets/images/email-template/1.png" alt="" width="80"></td>
                                <td valign="top" style="padding-left: 15px;">
                                    <h5 style="margin-top: 15px;">Three seater Wood Style sofa for Leavingroom </h5>
                                </td>
                                <td valign="top" style="padding-left: 15px;">
            ...
            <tr>
                <td style="padding: 30px;">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin: 20px auto 0;">
                        <tbody>
                            <tr>
                                <td><a href="#" style="font-size:13px">Want to change how you receive these emails?</a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <p style="font-size:13px; margin:0;">2018 - 19 Copy Right by Themeforest powerd by
                                        Pixel Strap</p>
                                </td>
                            </tr>
                            <tr>
