            ...
            <tr>
                <td>
                        ...
                        <tbody>
                            <tr class="header">
                                <td align="left" valign="top"><img class="main-logo"
                                        src="assets/images/logo/logo.png"></td>
                                <td class="menu" align="right">
                                    <ul>
                                        <li style="display: inline-block;text-decoration: unset"><a href="#"
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tbody>
                            <tr>
                                <td><img src="assets/images/email-template/1.jpg" alt="" style="width: 100%;"></td>
                            </tr>
                        </tbody>
                    </table>
                    <h4 class="title" style="text-align: center;">Additional 50% Off</h4>
                    <h5 style="text-align: center;">On clothes for kids,women & Mens Wear</h5>
                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                            ...
                            <tr>
                                <td>
                                    <div class="product-box hover">
                                        <div class="product border-theme br-0"><img
                                                src="assets/images/email-template/2.png" alt="product"
                                                ></div>
                                        <div class="product-info" style="text-align: center;"><a href="#" tabindex="0" style="text-align: center;">
                                ...
                                <td>
                                    <div class="product-box hover">
                                        <div class="product border-theme br-0"><img class="img-fluid"
                                                src="assets/images/email-template/7.png" alt="product"></div>
                                        <div class="product-info" style="text-align: center;">
                                            <div class="rating"><i class="fa fa-star"></i><i class="fa fa-star"></i><i
                                                    class="fa fa-star"></i><i class="fa fa-star"></i><i
                                                    class="fa fa-star"></i></div><a href="#" tabindex="0"
                                ...
                                <td>
                                    <div class="product-box hover">
                                        <div class="product border-theme br-0"><img class="img-fluid"
                                                src="assets/images/email-template/8.png" alt="product"></div>
                                        <div class="product-info" style="text-align: center;">
                                            <div class="rating"><i class="fa fa-star"></i><i class="fa fa-star"></i><i
                                                    class="fa fa-star"></i><i class="fa fa-star"></i><i
                                                    class="fa fa-star"></i></div><a href="#" tabindex="0"
                    ...
                    <table class="main-bg-light" border="0" cellpadding="0" cellspacing="0" width="100%"
                        ...
                        <tbody>
                            ...
                            <tr class="add-with-banner" align="center">
                                <td><img src="assets/images/email-template/3.png"></td>
                                <td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tbody>
                            <tr align="center">
                                <td><a href="#"><img src="assets/images/email-template/cosmetic.jpg"
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:30px;">
                        <tbody>
                            <tr class="add-with-banner" align="center">
                                <td><a href="#"><img src="assets/images/email-template/6.png"
                                            style="width:100%;"></a></td>
                                <td><a href="#"><img src="assets/images/email-template/5.png"
                                            style="width:100%;"></a></td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="main-bg-light text-center" align="center" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                ...
                                <td><a href="https://in.pinterest.com/login/"><img src="assets/images/email-template/pinterest.png" alt=""></a>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><a href="#" style="font-size:13px">Want to change how you receive
                                                        these emails?</a></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <p style="font-size:13px; margin:0;">2018 - 19 Copy Right by
                                                        Themeforest powerd by Pixel Strap</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><a href="#"
